...
- ao clicar em pokémon da listagem pegamos do id desse pokémon pra saber qual cartão mostrar
...
const pokemonnsCard = document.querySelectorAll('.cartao-pokemon')
